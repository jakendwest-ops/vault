...
| 6 | Plate calculator | 🟢 Low | **✅ Done 2026-07-10** | See Runner features table below. |
...
| **Plate calculator (what to load on the bar)** | **✅ Done 2026-07-10** | Standard 20kg bar + standard plate set, greedy per-side breakdown. Wizard: live hint under the weight input. Strength table: a PLATES/SIDE column in the existing target bar, not new text under rows (Jake had explicitly rejected under-row captions in that exact table before). app-runner v19. |
