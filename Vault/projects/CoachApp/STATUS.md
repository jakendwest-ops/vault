...
**App version:** app-core v=1 · app-dashboard v=2 · app-clients v=2 · app-programs v=9 · app-calendar-goals v=2 · app-workouts v=11 · app-runner v=10 · app-progress v=3
...
| **`.modal-box` (used in `app-progress.js`/`app-runner.js`) has no CSS definition either** — same undefined-class bug pattern, found alongside the item above. | Medium |
